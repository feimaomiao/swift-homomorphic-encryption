...
public struct Apple_SwiftHomomorphicEncryption_Pnns_V1_DatabaseRow: Sendable {
...
extension Apple_SwiftHomomorphicEncryption_Pnns_V1_DatabaseRow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{3}entry_id\0\u{3}entry_metadata\0\u{1}vector\0")
